...
def get_tax(value):
  global tax
  if value>0 and value<1001:
    n = value - 1000
    tax += n*0
    #print tax
    return tax
  elif value>1000 and value<10001:
    n = value - 1000
    tax += n*0.1
    get_tax(1000)
  elif value>10000 and value<20201:
    n = value - 10000
    tax += n*0.15
    get_tax(10000)
  elif value>20200 and value<30751:
    n = value - 20200
    tax += n*0.2
    get_tax(20200)
  elif value>30750 and value<50501:
    n = value - 30750
    tax += n*0.25
    get_tax(30750)
  elif value>50000:
...
d={'Alex': 500,'James': 20500,'Kinuthia': 70000}
#calculate_tax(d)
tests=['test_calculated_tax_is_a_float', 'test_it_calculates_tax_for_one_person', 'test_it_calculates_tax_for_several_people', 'test_it_does_not_accept_integers', 'test_it_return_an_empty_dict_for_an_empty_dict_input', 'test_it_returns_zero_tax_for_income_less_than_1000', 'test_it_throws_an_error_if_any_of_the_inputs_is_non_numeric']
for test in tests:
    t=CalculateTaxTests(test)
    print t.run()
